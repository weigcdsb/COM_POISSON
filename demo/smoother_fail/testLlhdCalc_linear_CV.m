function [llhd_mean, windSize] = testLlhdCalc_linear_CV(betaStart,betaEnd,gamStart,gamEnd,...
    k,nNew)

% betaStart,betaEnd,gamStart,gamEnd: start & end values of parameters
% k: recording length
% nNew: number of newly generated dataset
