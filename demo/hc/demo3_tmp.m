...
% Q = diag([repmat(1e-4,nknots+1,1); repmat(1e-3,Gnknots + 1,1)]); % multi G
...
save('C:\Users\gaw19004\Desktop\COM_POI_data\hc_10_QTune_noBin_20_1.mat')
...
hold on
plot(var_smoo./mean_smoo, 'b', 'LineWidth', 1)
plot(CMP_var./CMP_mean, 'r', 'LineWidth', 2)
title('fano factor')
hold off
